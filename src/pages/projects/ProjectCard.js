...
const ProjectCard = ({ project }) => {
    ...
    const { image, title, backEnd, frontEnd, liveLink, description, id } = project;
    return (
        <div className="card card-compact bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    {
                        project.details ? 
                        <Link to={`/project-details/${id}`}><button className="btn btn-sm btn-primary">Details <FaArrowRight /></button></Link>
                        :
                        <>
