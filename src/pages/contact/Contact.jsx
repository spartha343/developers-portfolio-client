...
const Contact = () => {
  ...
  const contactInfos = [
    {
      ...
      contactAddress: "+8801624457470",
      link: "tel:+8801624457470"
    },
    {
      contactType: "Email",
      contactIcon: <MdOutlineAttachEmail />,
      contactAddress: "spartha343@gmail.com",
    ...
    },
    {
      ...
      contactAddress: "+8801624457470",
      link: "https://api.whatsapp.com/send/?phone=%2B8801624457470&text&type=phone_number&app_absent=0"
    },
    {
      contactType: "Dribbble",
      contactIcon: <FaWhatsapp />,
      contactAddress: "Coming Sooon.."
    }
  ];
  const description =
    "If you have any queries or even just to say hello, please fill out the form and i will get to you soon";
  ...
  return (
    <div>
      ...
      <SectionHeader text="Connect" description={description}>
        With Me
      </SectionHeader>
        ...
        <div className="font-semibold w-full md:w-80 mr-5 grid grid-cols-1">
          {contactInfos.map((info, idx) => (
            <Link
              to={info?.link}
              key={idx}
              className="p-2 mb-2 rounded-lg shadow-md hover:shadow-xl"
            >
          ...
          <div>
            ...
            <div className="text-secondary text-2xl flex">
              <FaPhone
                size={18}
                className="mr-4 relative bottom-0 hover:bottom-2 cursor-pointer ease-in-out duration-700"
              />
